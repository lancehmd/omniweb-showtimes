<?php
/**
 * OmniwebShowtimes_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'OmniwebShowtimes_AceCustomFieldType' ) ) :
class OmniwebShowtimes_AceCustomFieldType extends OmniwebShowtimes_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.omniweb-showtimes-field' ).nextAll().andSelf().each( function( iIndex ) {
    ...
    public function getField( $aField ) {
        ...
        return
            $aField['before_label']
            . "<div class='omniweb-showtimes-input-label-container'>"
