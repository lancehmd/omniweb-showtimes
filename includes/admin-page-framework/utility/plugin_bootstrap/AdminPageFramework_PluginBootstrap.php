...
abstract class OmniwebShowtimes_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('OmniwebShowtimes_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new OmniwebShowtimes_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
