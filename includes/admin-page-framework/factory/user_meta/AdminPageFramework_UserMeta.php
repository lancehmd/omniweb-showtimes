...
abstract class OmniwebShowtimes_AdminPageFramework_UserMeta_Router extends OmniwebShowtimes_AdminPageFramework_Factory {
...
abstract class OmniwebShowtimes_AdminPageFramework_UserMeta_Model extends OmniwebShowtimes_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new OmniwebShowtimes_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class OmniwebShowtimes_AdminPageFramework_UserMeta_View extends OmniwebShowtimes_AdminPageFramework_UserMeta_Model {
...
abstract class OmniwebShowtimes_AdminPageFramework_UserMeta_Controller extends OmniwebShowtimes_AdminPageFramework_UserMeta_View {
...
abstract class OmniwebShowtimes_AdminPageFramework_UserMeta extends OmniwebShowtimes_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'omniweb-showtimes') {
