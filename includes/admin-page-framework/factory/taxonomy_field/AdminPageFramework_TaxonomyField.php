...
abstract class OmniwebShowtimes_AdminPageFramework_TaxonomyField_Router extends OmniwebShowtimes_AdminPageFramework_Factory {
...
abstract class OmniwebShowtimes_AdminPageFramework_TaxonomyField_Model extends OmniwebShowtimes_AdminPageFramework_TaxonomyField_Router {
...
abstract class OmniwebShowtimes_AdminPageFramework_TaxonomyField_View extends OmniwebShowtimes_AdminPageFramework_TaxonomyField_Model {
...
abstract class OmniwebShowtimes_AdminPageFramework_TaxonomyField_Controller extends OmniwebShowtimes_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class OmniwebShowtimes_AdminPageFramework_TaxonomyField extends OmniwebShowtimes_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'omniweb-showtimes') {
