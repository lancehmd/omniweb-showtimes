...
abstract class OmniwebShowtimes_AdminPageFramework_MetaBox_Router extends OmniwebShowtimes_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'omniweb-showtimes') {
...
abstract class OmniwebShowtimes_AdminPageFramework_MetaBox_Model extends OmniwebShowtimes_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'omniweb-showtimes') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new OmniwebShowtimes_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class OmniwebShowtimes_AdminPageFramework_MetaBox_View extends OmniwebShowtimes_AdminPageFramework_MetaBox_Model {
...
abstract class OmniwebShowtimes_AdminPageFramework_MetaBox_Controller extends OmniwebShowtimes_AdminPageFramework_MetaBox_View {
...
abstract class OmniwebShowtimes_AdminPageFramework_MetaBox extends OmniwebShowtimes_AdminPageFramework_MetaBox_Controller {
