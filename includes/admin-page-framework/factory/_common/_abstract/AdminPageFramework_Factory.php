...
abstract class OmniwebShowtimes_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'OmniwebShowtimes_AdminPageFramework_Form_', 'oPageLoadInfo' => 'OmniwebShowtimes_AdminPageFramework_PageLoadInfo_', 'oResource' => 'OmniwebShowtimes_AdminPageFramework_Resource_', 'oHelpPane' => 'OmniwebShowtimes_AdminPageFramework_HelpPane_', 'oLink' => 'OmniwebShowtimes_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'OmniwebShowtimes_AdminPageFramework_Debug', 'oUtil' => 'OmniwebShowtimes_AdminPageFramework_FrameworkUtility', 'oMsg' => 'OmniwebShowtimes_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(OmniwebShowtimes_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
...
abstract class OmniwebShowtimes_AdminPageFramework_Factory_Model extends OmniwebShowtimes_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class OmniwebShowtimes_AdminPageFramework_Factory_View extends OmniwebShowtimes_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new OmniwebShowtimes_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class OmniwebShowtimes_AdminPageFramework_Factory_Controller extends OmniwebShowtimes_AdminPageFramework_Factory_View {
...
abstract class OmniwebShowtimes_AdminPageFramework_Factory extends OmniwebShowtimes_AdminPageFramework_Factory_Controller {
}
