...
abstract class OmniwebShowtimes_AdminPageFramework_Property_Base extends OmniwebShowtimes_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'omniweb-showtimes' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['aOmniwebShowtimes_AdminPageFramework'])) {
            $GLOBALS['aOmniwebShowtimes_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => OmniwebShowtimes_AdminPageFramework_Registry::NAME, 'sURI' => OmniwebShowtimes_AdminPageFramework_Registry::URI, 'sScriptName' => OmniwebShowtimes_AdminPageFramework_Registry::NAME, 'sLibraryName' => OmniwebShowtimes_AdminPageFramework_Registry::NAME, 'sLibraryURI' => OmniwebShowtimes_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => OmniwebShowtimes_AdminPageFramework_Registry::getVersion(), 'sDescription' => OmniwebShowtimes_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => OmniwebShowtimes_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => OmniwebShowtimes_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => OmniwebShowtimes_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => OmniwebShowtimes_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new OmniwebShowtimes_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
