...
abstract class OmniwebShowtimes_AdminPageFramework_Input_Base extends OmniwebShowtimes_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'omniweb-showtimes-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'omniweb-showtimes-input-label-string',),);
...
class OmniwebShowtimes_AdminPageFramework_Input_checkbox extends OmniwebShowtimes_AdminPageFramework_Input_Base {
    public function get() {
