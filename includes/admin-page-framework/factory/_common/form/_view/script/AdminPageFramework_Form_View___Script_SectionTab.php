...
class OmniwebShowtimes_AdminPageFramework_Form_View___Script_SectionTab extends OmniwebShowtimes_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.omniweb-showtimes-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='omniweb-showtimes-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
