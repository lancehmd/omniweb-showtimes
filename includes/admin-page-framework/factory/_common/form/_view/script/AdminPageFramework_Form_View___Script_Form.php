...
class OmniwebShowtimes_AdminPageFramework_Form_View___Script_Form extends OmniwebShowtimes_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removeOmniwebShowtimes_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.omniweb-showtimes-form-loading' ).remove();
        jQuery( '.omniweb-showtimes-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.omniweb-showtimes-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removeOmniwebShowtimes_AdminPageFrameworkLoadingOutputs();
