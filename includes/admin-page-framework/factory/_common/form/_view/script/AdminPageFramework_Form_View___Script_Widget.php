...
class OmniwebShowtimes_AdminPageFramework_Form_View___Script_Widget extends OmniwebShowtimes_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.omniweb-showtimes-sectionset' ).length <= 0 ) { 
                    return; 
                }   
                ...
                $( document ).trigger( 
                    'omniweb-showtimes_saved_widget', 
                    _oWidget 
                );
