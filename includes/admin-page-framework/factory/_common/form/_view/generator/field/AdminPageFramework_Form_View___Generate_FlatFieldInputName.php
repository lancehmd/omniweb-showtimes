...
class OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FieldInputName extends OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
...
class OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FlatFieldInputName extends OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FieldInputName {
    public function get() {
        $_sIndex = $this->getAOrB('0' !== $this->sIndex && empty($this->sIndex), '', "|{$this->sIndex}");
