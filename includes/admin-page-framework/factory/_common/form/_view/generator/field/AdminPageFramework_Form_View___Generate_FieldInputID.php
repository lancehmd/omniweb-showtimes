...
class OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FieldTagID extends OmniwebShowtimes_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FieldInputID extends OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
