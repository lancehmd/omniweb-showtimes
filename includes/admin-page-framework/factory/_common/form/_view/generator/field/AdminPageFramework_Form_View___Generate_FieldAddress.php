...
abstract class OmniwebShowtimes_AdminPageFramework_Form_View___Generate_Field_Base extends OmniwebShowtimes_AdminPageFramework_Form_View___Generate_Section_Base {
...
class OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FieldName extends OmniwebShowtimes_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FlatFieldName extends OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FieldName {
    public function get() {
...
class OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FieldAddress extends OmniwebShowtimes_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public function get() {
