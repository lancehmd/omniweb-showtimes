...
abstract class OmniwebShowtimes_AdminPageFramework_Form_View___Attribute_Base extends OmniwebShowtimes_AdminPageFramework_Form_Utility {
    public $sContext = '';
...
abstract class OmniwebShowtimes_AdminPageFramework_Form_View___Attribute_FieldContainer_Base extends OmniwebShowtimes_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getFormattedAttributes() {
...
class OmniwebShowtimes_AdminPageFramework_Form_View___Attribute_Field extends OmniwebShowtimes_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    public $sContext = 'field';
    protected function _getAttributes() {
        $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " omniweb-showtimes-field-{$this->aArguments['type']}", '');
        ...
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "omniweb-showtimes-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' omniweb-showtimes-subfield', ''));
    }
}
