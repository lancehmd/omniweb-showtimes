...
class OmniwebShowtimes_AdminPageFramework_Form_View___Description extends OmniwebShowtimes_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'omniweb-showtimes-form-element-description';
