...
class OmniwebShowtimes_AdminPageFramework_FieldType_radio extends OmniwebShowtimes_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".omniweb-showtimes-field input[type='radio'] {margin-right: 0.5em;} .omniweb-showtimes-field-radio .omniweb-showtimes-input-label-container {padding-right: 1em;} .omniweb-showtimes-field-radio .omniweb-showtimes-input-container {display: inline;} .omniweb-showtimes-field-radio .omniweb-showtimes-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.omniweb-showtimes-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
