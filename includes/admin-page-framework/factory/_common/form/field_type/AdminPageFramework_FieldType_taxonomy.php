...
class OmniwebShowtimes_AdminPageFramework_FieldType_taxonomy extends OmniwebShowtimes_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new OmniwebShowtimes_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableOmniwebShowtimes_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableOmniwebShowtimes_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerOmniwebShowtimes_AdminPageFrameworkCallbacks( {     
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            enableOmniwebShowtimes_AdminPageFrameworkTabbedBox( jQuery( oCloned ).find( '.tab-box-container' ) );            
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".omniweb-showtimes-field .taxonomy-checklist li { margin: 8px 0 8px 20px; }.omniweb-showtimes-field div.taxonomy-checklist {padding: 8px 0 8px 10px;margin-bottom: 20px;}.omniweb-showtimes-field .taxonomy-checklist ul {list-style-type: none;margin: 0;}.omniweb-showtimes-field .taxonomy-checklist ul ul {margin-left: 1em;}.omniweb-showtimes-field .taxonomy-checklist-label {white-space: nowrap; }.omniweb-showtimes-field .tab-box-container.categorydiv {max-height: none;}.omniweb-showtimes-field .tab-box-tab-text {display: inline-block;}.omniweb-showtimes-field .tab-box-tabs {line-height: 12px;margin-bottom: 0;}.omniweb-showtimes-field .tab-box-tabs .tab-box-tab.active {display: inline;border-color: #dfdfdf #dfdfdf #fff;margin-bottom: 0px;padding-bottom: 2px;background-color: #fff;}.omniweb-showtimes-field .tab-box-container { position: relative; width: 100%; clear: both;margin-bottom: 1em;}.omniweb-showtimes-field .tab-box-tabs li a { color: #333; text-decoration: none; }.omniweb-showtimes-field .tab-box-contents-container {padding: 0 0 0 1.8em;padding: 0.55em 0.5em 0.55em 1.8em;border: 1px solid #dfdfdf; background-color: #fff;}.omniweb-showtimes-field .tab-box-contents { overflow: hidden; overflow-x: hidden; position: relative; top: -1px; height: 300px;}.omniweb-showtimes-field .tab-box-content { display: none; overflow: auto; display: block; position: relative; overflow-x: hidden;}.omniweb-showtimes-field .tab-box-content .taxonomychecklist {margin-right: 3.2em;}.omniweb-showtimes-field .tab-box-content:target, .omniweb-showtimes-field .tab-box-content:target, .omniweb-showtimes-field .tab-box-content:target { display: block; }.omniweb-showtimes-field .tab-box-content .select_all_button_container, .omniweb-showtimes-field .tab-box-content .select_none_button_container{margin-top: 0.8em;}.omniweb-showtimes-field .taxonomychecklist .children {margin-top: 6px;margin-left: 1em;}";
    }
