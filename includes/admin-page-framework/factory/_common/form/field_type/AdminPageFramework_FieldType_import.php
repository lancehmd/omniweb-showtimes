...
class OmniwebShowtimes_AdminPageFramework_FieldType_import extends OmniwebShowtimes_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".omniweb-showtimes-field-import input {margin-right: 0.5em;}.omniweb-showtimes-field-import label,.form-table td fieldset.omniweb-showtimes-fieldset .omniweb-showtimes-field-import label { display: inline; }";
    }
