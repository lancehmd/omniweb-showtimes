...
class OmniwebShowtimes_AdminPageFramework_FieldType_submit extends OmniwebShowtimes_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".omniweb-showtimes-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'omniweb-showtimes-input-label-container' . ' omniweb-showtimes-input-button-container' . ' omniweb-showtimes-input-container',);
    }
...
class OmniwebShowtimes_AdminPageFramework_FieldType_export extends OmniwebShowtimes_AdminPageFramework_FieldType_submit {
