...
class OmniwebShowtimes_AdminPageFramework_FrameworkUtility extends OmniwebShowtimes_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = OmniwebShowtimes_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return OmniwebShowtimes_AdminPageFramework_Registry::NAME;
    }
}
class OmniwebShowtimes_AdminPageFramework_ArrayHandler extends OmniwebShowtimes_AdminPageFramework_FrameworkUtility {
    public $aData = array();
