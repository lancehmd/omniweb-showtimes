...
class OmniwebShowtimes_AdminPageFramework_AdminNotice extends OmniwebShowtimes_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'omniweb-showtimes-settings-notice-message', 'omniweb-showtimes-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new OmniwebShowtimes_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
