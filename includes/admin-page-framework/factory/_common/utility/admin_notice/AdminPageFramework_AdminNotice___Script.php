...
class OmniwebShowtimes_AdminPageFramework_AdminNotice___Script extends OmniwebShowtimes_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.omniweb-showtimes-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='omniweb-showtimes-admin-notice-animation-container'></div>" );
