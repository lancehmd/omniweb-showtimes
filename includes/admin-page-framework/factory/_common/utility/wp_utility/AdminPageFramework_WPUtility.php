...
class OmniwebShowtimes_AdminPageFramework_WPUtility_URL extends OmniwebShowtimes_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(OmniwebShowtimes_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(OmniwebShowtimes_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = OmniwebShowtimes_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class OmniwebShowtimes_AdminPageFramework_WPUtility_HTML extends OmniwebShowtimes_AdminPageFramework_WPUtility_URL {
...
class OmniwebShowtimes_AdminPageFramework_WPUtility_Page extends OmniwebShowtimes_AdminPageFramework_WPUtility_HTML {
...
class OmniwebShowtimes_AdminPageFramework_WPUtility_Hook extends OmniwebShowtimes_AdminPageFramework_WPUtility_Page {
...
class OmniwebShowtimes_AdminPageFramework_WPUtility_File extends OmniwebShowtimes_AdminPageFramework_WPUtility_Hook {
...
class OmniwebShowtimes_AdminPageFramework_WPUtility_Option extends OmniwebShowtimes_AdminPageFramework_WPUtility_File {
...
class OmniwebShowtimes_AdminPageFramework_WPUtility_Meta extends OmniwebShowtimes_AdminPageFramework_WPUtility_Option {
...
class OmniwebShowtimes_AdminPageFramework_WPUtility_SiteInformation extends OmniwebShowtimes_AdminPageFramework_WPUtility_Meta {
...
class OmniwebShowtimes_AdminPageFramework_WPUtility_SystemInformation extends OmniwebShowtimes_AdminPageFramework_WPUtility_SiteInformation {
...
class OmniwebShowtimes_AdminPageFramework_WPUtility extends OmniwebShowtimes_AdminPageFramework_WPUtility_SystemInformation {
