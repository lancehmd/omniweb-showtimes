...
abstract class OmniwebShowtimes_AdminPageFramework_Widget_Router extends OmniwebShowtimes_AdminPageFramework_Factory {
...
abstract class OmniwebShowtimes_AdminPageFramework_Widget_Model extends OmniwebShowtimes_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new OmniwebShowtimes_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class OmniwebShowtimes_AdminPageFramework_Widget_View extends OmniwebShowtimes_AdminPageFramework_Widget_Model {
...
abstract class OmniwebShowtimes_AdminPageFramework_Widget_Controller extends OmniwebShowtimes_AdminPageFramework_Widget_View {
...
abstract class OmniwebShowtimes_AdminPageFramework_Widget extends OmniwebShowtimes_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'omniweb-showtimes') {
