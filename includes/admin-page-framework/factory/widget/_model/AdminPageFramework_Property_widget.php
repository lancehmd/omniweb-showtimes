...
class OmniwebShowtimes_AdminPageFramework_Property_widget extends OmniwebShowtimes_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'omniweb-showtimes', $sStructureType) {
