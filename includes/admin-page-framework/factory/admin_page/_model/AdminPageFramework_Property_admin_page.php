...
class OmniwebShowtimes_AdminPageFramework_Property_admin_page extends OmniwebShowtimes_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'omniweb-showtimes') {
        ...
        $GLOBALS['aOmniwebShowtimes_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aOmniwebShowtimes_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aOmniwebShowtimes_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
