...
abstract class OmniwebShowtimes_AdminPageFramework_CustomSubmitFields extends OmniwebShowtimes_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class OmniwebShowtimes_AdminPageFramework_ExportOptions extends OmniwebShowtimes_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo OmniwebShowtimes_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
