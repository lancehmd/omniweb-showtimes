...
class OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__Filter extends OmniwebShowtimes_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
