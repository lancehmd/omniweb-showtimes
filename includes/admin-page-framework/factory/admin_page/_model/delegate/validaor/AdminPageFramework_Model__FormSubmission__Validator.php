...
class OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator_Base extends OmniwebShowtimes_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator extends OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__Link', 'OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__Import', 'OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__Export', 'OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
