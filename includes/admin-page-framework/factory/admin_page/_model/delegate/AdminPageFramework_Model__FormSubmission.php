...
abstract class OmniwebShowtimes_AdminPageFramework_Model__FormSubmission_Base extends OmniwebShowtimes_AdminPageFramework_FrameworkUtility {
...
class OmniwebShowtimes_AdminPageFramework_Model__FormSubmission extends OmniwebShowtimes_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new OmniwebShowtimes_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new OmniwebShowtimes_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
