...
abstract class OmniwebShowtimes_AdminPageFramework_TermMeta_Router extends OmniwebShowtimes_AdminPageFramework_TaxonomyField_Controller {
}
abstract class OmniwebShowtimes_AdminPageFramework_TermMeta_Model extends OmniwebShowtimes_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new OmniwebShowtimes_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class OmniwebShowtimes_AdminPageFramework_TermMeta_View extends OmniwebShowtimes_AdminPageFramework_TermMeta_Model {
...
abstract class OmniwebShowtimes_AdminPageFramework_TermMeta_Controller extends OmniwebShowtimes_AdminPageFramework_TermMeta_View {
}
abstract class OmniwebShowtimes_AdminPageFramework_TermMeta extends OmniwebShowtimes_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'omniweb-showtimes') {
