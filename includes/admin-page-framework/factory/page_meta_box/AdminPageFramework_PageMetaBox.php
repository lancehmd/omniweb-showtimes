...
abstract class OmniwebShowtimes_AdminPageFramework_PageMetaBox_Router extends OmniwebShowtimes_AdminPageFramework_MetaBox_View {
...
abstract class OmniwebShowtimes_AdminPageFramework_PageMetaBox_Model extends OmniwebShowtimes_AdminPageFramework_PageMetaBox_Router {
...
abstract class OmniwebShowtimes_AdminPageFramework_PageMetaBox_View extends OmniwebShowtimes_AdminPageFramework_PageMetaBox_Model {
}
abstract class OmniwebShowtimes_AdminPageFramework_PageMetaBox_Controller extends OmniwebShowtimes_AdminPageFramework_PageMetaBox_View {
...
abstract class OmniwebShowtimes_AdminPageFramework_PageMetaBox extends OmniwebShowtimes_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'omniweb-showtimes') {
