...
class OmniwebShowtimes_AdminPageFramework_Property_page_meta_box extends OmniwebShowtimes_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'omniweb-showtimes', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aOmniwebShowtimes_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aOmniwebShowtimes_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aOmniwebShowtimes_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aOmniwebShowtimes_AdminPageFramework', 'aPageClasses'));
